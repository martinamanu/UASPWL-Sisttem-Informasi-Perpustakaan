    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/user/edit/<?= $userinfo->id; ?>">
                        <div class="form-group">
                            <label for="nama">Nama</label>
                            <input type="text" class="form-control <?= (!empty($validation->getError("nama")) ? "is-invalid" : "") ?>" name="nama" value="<?= $userinfo->name; ?>" id="nama" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (!empty($validation->getError("email")) ? "is-invalid" : "") ?>" name="email" value="<?= $userinfo->email; ?>" id="email" />
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select <?= (!empty($validation->getError("jabatan")) ? "is-invalid" : "") ?>" name="jabatan">
                                ...
                                <?php foreach ($jabatan as $row) : ?>
                                    <?php if ($userinfo->level_id === $row->id) : ?>
