            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="" id='edit-user'>
                        ...
                        <input type="text" class="form-control @error('nama_user') is-invalid @enderror" name="nama_user" id="nama_user"/>
                            @error('nama_user')
                        ...
                        <div class="form-group">
                            ...
                            {{-- <input type="text" class="form-control @error('level') is-invalid @enderror" name="level" value="{{$data->level}}"  id="level"/> --}}
                            @error('level')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
